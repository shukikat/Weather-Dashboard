...
class WeatherService {
  ...
  const { latitude, longitude, city: cityName } = this.destructuredLocationData(locationData[0])
  ...
  const weatherData = this.buildWeatherQuery(coordinates.latitude, coordinates.longitude)
